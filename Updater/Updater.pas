...
begin
  ...
  begin
    ...
    lvUpdater.Items.Add;
    lvUpdater.Items.item[lvUpdater.Items.Count - 1].Caption :=
        QIPPlugin.GetLang(LI_UPDATE_LOG_NEXT_TEXT) + ' ' +
        LNG('UPDATER','RestartQIP','QIP Infium will be restart.');  //LNG('UPDATER','ClickContinue','Click "Continue" button for updating...');
    lvUpdater.Items.item[lvUpdater.Items.Count - 1].ImageIndex := 4;
    //lvUpdater.Items.item[lvUpdater.Items.Count - 1].SubItems.Add( '' );
    lvUpdater.Scroll(0,lvUpdater.Items.Count * 10);
