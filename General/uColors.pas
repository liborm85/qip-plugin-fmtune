...
interface
uses
  SysUtils, Classes, Dialogs, Graphics, Windows,
  u_common;
...
//  cl
  ...
  else if sColor = AnsiUpperCase('BgClColor') then
  begin
    Result := qipcolors.BgClColor;
  end
  else if sColor = AnsiUpperCase('BgMsgColor') then
  begin
    Result := qipcolors.BgMsgColor;
  end
  else if sColor = AnsiUpperCase('BgChatColor') then
  begin
    Result := qipcolors.BgChatColor;
  end
  else
  begin
    Result := ConvStrToInt(sColor);
  end;
end;
