...
const
  PLUGIN_VER_MAJOR    = 0;
  PLUGIN_VER_MINOR    = 6;
  PLUGIN_VER_RELEASE  = 3;
  PLUGIN_VER_BUILD    = 1;
  PLUGIN_VER_BETA     : WideString = ' beta'; // defaultnì ''; jsem se píše Alfa, Beta, apod.
  PLUGIN_NAME         : WideString = 'FMtune';
  PLUGIN_AUTHOR       : WideString = 'Lms, panther7';
  PLUGIN_AUTHOR_EMAIL : WideString = 'lms.cze7@gmail.com';
  PLUGIN_WEB          : WideString = 'http://qipim.cz/viewtopic.php?t=1867';
  PLUGIN_DESC         : WideString = 'Internet radio player';
  PLUGIN_HINT         : WideString = 'Unique plugin for playing internet radio stations, that''s FMtune!'; // + #13#10 + 'Multiline hint.'
