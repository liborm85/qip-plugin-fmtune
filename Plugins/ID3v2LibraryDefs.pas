...
uses
  Windows, SysUtils, Classes;
    ...
    function InitID3v2Library(Path: WideString): Boolean;
...
begin
    ...
    ID3v2DLLHandle := SafeLoadLibrary(PWideChar(Path + 'Plugins\' + ID3v2DLL));
    Result := ID3v2DLLHandle <> 0;
    if Result then begin
        ID3v1_Create            := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Create));
        ID3v1_Free              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Free));
        ID3v1_Load              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Load));
        ID3v1_Save              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Save));
        ID3v1_Kill              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Kill));
        ID3v1_GetTitle          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetTitle));
        ID3v1_SetTitle          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetTitle));
        ID3v1_GetArtist         := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetArtist));
        ID3v1_SetArtist         := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetArtist));
        ID3v1_GetAlbum          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetAlbum));
        ID3v1_SetAlbum          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetAlbum));
        ID3v1_GetYear           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetYear));
        ID3v1_SetYear           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetYear));
        ID3v1_GetComment        := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetComment));
        ID3v1_SetComment        := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetComment));
        ID3v1_GetTrack          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetTrack));
        ID3v1_SetTrack          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetTrack));
        ID3v1_GetGenre          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GetGenre));
        ID3v1_SetGenre          := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_SetGenre));
        ID3v1_GenreByte2Text    := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GenreByte2Text));
        ID3v1_Rev1              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_Rev1));
        ID3v1_GenreListToData   := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GenreListToData));
        ID3v1_GenreDataToList   := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v1_GenreDataToList));


        ID3v2_Create            := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Create));
        ID3v2_Free              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Free));
        ID3v2_Kill              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Kill));
        ID3v2_Load              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Load));
        ID3v2_LoadFromStream    := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_LoadFromStream));
        ID3v2_Loaded            := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Loaded));
        ID3v2_Save              := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_Save));
        ID3v2_SaveToStream      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SaveToStream));
        ID3v2_GetAsciiText      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetAsciiText));
        ID3v2_SetAsciiText      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SetAsciiText));
        ID3v2_FrameCount        := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_FrameCount));
        ID3v2_GetFrameData      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetFrameData));
        ID3v2_SetFrameData      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SetFrameData));
        ID3v2_CheckFrameExists  := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_CheckFrameExists));
        ID3v2_GetFrameID        := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetFrameID));
        ID3v2_DeleteFrame       := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_DeleteFrame));
        ID3v2_CreateFrame       := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_CreateFrame));
        ID3v2_CompressFrame     := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_CompressFrame));
        ID3v2_DeCompressFrame   := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_DeCompressFrame));
        ID3v2_AddAlbumPicture   := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_AddAlbumPicture));
        ID3v2_GetAlbumPicture   := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetAlbumPicture));
        ID3v2_GetAlbumPictureStream := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetAlbumPictureStream));
        ID3v2_SyncFrame         := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SyncFrame));
        ID3v2_UnSyncFrame       := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_UnSyncFrame));
        ID3v2_SetCOMM           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SetCOMM));
        ID3v2_GetCOMM           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetCOMM));
        ID3v2_SetWXXX           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SetWXXX));
        ID3v2_GetWXXX           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetWXXX));
        ID3v2_GetFrameDataP     := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetFrameDataP));
        ID3v2_SetFrameDataP     := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_SetFrameDataP));
        ID3v2_GetFrameSize      := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_GetFrameSize));
        ID3v2_FrameTypeCount    := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_FrameTypeCount));
        ID3v2_TagSize           := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_TagSize));
        ID3v2_TagMajorVer       := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_TagMajorVer));
        ID3v2_TagMinorVer       := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_TagMinorVer));
        ID3v2_FrameIsCompressed := GetProcAddress(ID3v2DLLHandle, PAnsiChar(NAME_ID3v2_FrameIsCompressed));
    end;
    if (@ID3v1_Create = nil)
    OR (@ID3v1_Free = nil)
    OR (@ID3v1_Load = nil)
